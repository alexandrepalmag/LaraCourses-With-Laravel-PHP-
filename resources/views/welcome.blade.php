...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="test-with-routes">
                <h2>Test with routes</h2>
                <form action="contact" method="post">
                    {{ csrf_field() }}
                    <input type="text" name="name-user" placeholder="Name /POST">
                    <button class="btn btn-danger" type="">Send</button>
                </form>
                <h2>Test with routes - PUT</h2>
                <form action="contact" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" name="_method" value="put">
                    <input type="text" name="name-user" placeholder="Name /PUT">
                    <button class="btn btn-danger" type="">Send</button>
                </form>
            </div>
        </div>
